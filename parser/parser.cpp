...
static const yytype_uint8 yyprhs[] =
{
      ...
      35,    38,    42,    46,    48,    51,    54,    56,    59,    63,
      67,    68,    72,    76,    78,    80,    82,    84,    86,    88,
      90,    92
};
...
static const yytype_int8 yyrhs[] =
{
      18,     0,    -1,    19,    -1,    20,    -1,    19,    20,    -1,
       9,     4,    15,    21,    16,    13,    22,    14,    -1,     9,
       4,    11,     4,    15,    21,    16,    13,    22,    14,    -1,
      -1,     3,    21,    -1,    -1,    23,    22,    -1,     3,    24,
      27,    -1,     4,     3,    24,    -1,     4,    -1,     4,     3,
      -1,    30,    26,    -1,     4,    -1,     4,    30,    -1,     4,
      30,    26,    -1,    13,    28,    14,    -1,    -1,    25,    12,
      28,    -1,    30,    12,    28,    -1,    25,    -1,    30,    -1,
       7,    -1,     8,    -1,     6,    -1,     5,    -1,     3,    -1,
      27,    -1,    15,    29,    16,    -1
};
...
static const yytype_uint8 yyrline[] =
{
      ...
      95,    98,   101,   103,   104,   109,   112,   113,   114,   118,
...
static const yytype_uint8 yydefact[] =
{
       0,     0,     0,     2,     3,     0,     1,     4,     0,     7,
       0,     7,     0,     7,     8,     0,     0,     9,     0,     0,
       0,     9,     9,    13,     0,     5,    10,     0,    14,    20,
      11,     6,    12,    29,    28,    27,    25,    26,     0,     0,
      30,     0,     0,    23,     0,    24,    20,    19,    16,    20,
      15,    31,    21,    17,    22,    18
};
...
{
       7,    16,    21,     7,   -38,    -2,   -38,   -38,    18,    20,
       9,    20,    10,    20,   -38,    12,    11,    25,    17,    27,
      15,    25,    25,    29,    22,   -38,   -38,    19,    27,    -3,
     -38,   -38,   -38,   -38,   -38,   -38,   -38,   -38,    -3,    24,
     -38,    23,     2,   -38,    26,    30,    -3,   -38,    -3,    -3,
     -38,   -38,   -38,    30,   -38,   -38
};
...
{
      33,    45,    34,    35,    36,    37,    48,    26,    27,     8,
      29,    53,    38,     9,    49,    52,     1,    14,    54,    16,
       5,     6,    10,    11,    13,    17,    15,    18,    19,    25,
      22,    23,    28,    31,    48,    29,    46,    47,     7,    43,
      55,    32,    51,     0,     0,     0,     0,     0,     0,     0,
       0,     0,    30
};

static const yytype_int8 yycheck[] =
{
       3,    38,     5,     6,     7,     8,     4,    21,    22,    11,
      13,    48,    15,    15,    12,    46,     9,    11,    49,    13,
       4,     0,     4,     3,    15,    13,    16,    16,     3,    14,
      13,     4,     3,    14,     4,    13,    12,    14,     3,    38,
      53,    28,    16,    -1,    -1,    -1,    -1,    -1,    -1,    -1,
      -1,    -1,    24
};
...
{
       0,     9,    18,    19,    20,     4,     0,    20,    11,    15,
       4,     3,    21,    15,    21,    16,    21,    13,    16,     3,
      22,    23,    13,     4,    24,    14,    22,    22,     3,    13,
      27,    14,    24,     3,     5,     6,     7,     8,    15,    25,
      27,    28,    30,    25,    29,    30,    12,    14,     4,    12,
      26,    16,    28,    30,    28,    26
};
...
/* Line 1455 of yacc.c  */
#line 104 "parser.y"
    { (yyval.messagePredicate) = new ast::MessagePredicate((yyvsp[(1) - (2)].string)); (yyval.messagePredicate)->methodVars->push_back(new ast::Expression()); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 130 "parser.y"
    { (yyval.expression) = new ast::Value(*(yyvsp[(1) - (1)].string), ast::Integer); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 131 "parser.y"
    { (yyval.expression) = new ast::Value(*(yyvsp[(1) - (1)].string), ast::Decimal); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 132 "parser.y"
    { (yyval.expression) = new ast::Value(*(yyvsp[(1) - (1)].string), ast::Character); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 133 "parser.y"
    { (yyval.expression) = new ast::Value(*(yyvsp[(1) - (1)].string), ast::String); ;}
    break;
